import os
import fnmatch  # use this to match files whose file names follow some sort of pattern, est. in your function parameter
                # 'artist_name'
...
album_list = find_albums("music", "black*")  # u can use an '*' as a wildcard in the second parameter 'Black*'
