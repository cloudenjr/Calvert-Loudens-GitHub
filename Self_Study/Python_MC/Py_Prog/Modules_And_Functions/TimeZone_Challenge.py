...
#
# The program will then display the time in that timezone, as well as local time and UTC
# time.
#
# Entering 0 as the choice will quit the program.
#
# Display the dates and times in a format suitable for the user of your program to
# understand, and include the timezone name when displaying the chosen time.
# *******************************************************************************************************************
...
# tz_menu_list = random.randint(1,10)
