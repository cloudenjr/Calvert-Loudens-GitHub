...
# creating the scrolling list/listbox
...
rbValue.set(3)  # this is the default value for the radio buttons
...
minuteSpinner = tkinter.Spinbox(timeFrame, width=2, from_=0, to=59)  # another way of showing values, like the hrs above
...
timeFrame['padx'] = 36    #  adds padding to the widget; 'x' for left/right and 'y' for top/bottom
...
yearSpin = tkinter.Spinbox(dateFrame, width=5, from_=2000, to_=2009)
