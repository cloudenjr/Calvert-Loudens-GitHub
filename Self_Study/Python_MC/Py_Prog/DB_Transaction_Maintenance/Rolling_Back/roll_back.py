# ********************************************************************************************************************
# - creating a class that can store itself to a database and initialize itself from that database if that DB exists
#
#
# *********************************************************************************************************************
...
class Account(object):
    ...
    def _save_update(self, amount):
        ...
        # finally:  # this is only here b/c programmers use try/finally blocks to protect code
        #     db.commit()
